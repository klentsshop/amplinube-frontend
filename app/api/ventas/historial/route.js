...
export async function POST(request) {
    try {
        ...
        const { fechaSeleccionada, tenantId } = body; 
        if (!tenantId) {
        ...
        // CONSULTA BLINDADA
       const query = `*[_type == "venta" && tenant == $tenantId && (
        ...
        const ventasRaw = await sanityClientServer.fetch(query, { inicio, fin, tenantId }, { useCdn: false });
